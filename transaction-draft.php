...
<html>
    ...
    <body id='main'>
        <div class="slide-out-div">
            <? //include_once("modificationHistory.php?id=".$fetch['TransactionID']); ?>
            <h3>Hodification History:</h3>
             <?php
                ...
                while($row = mysql_fetch_array($result)){
                    echo 
                        ...
                        "' onclick='showHistory(this.id)'>".
                        $row['ModificationPersonID'].
                        " - ".$row['ModificationDate']."</li>";
                }    
            ?>
        </div><!-- end slide out-->
